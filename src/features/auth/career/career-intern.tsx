...
import { useGetAllCareerInternQuery, UserProfile } from '@/api/career';
...
function CareerIntern() {
  ...
  const { data } = useGetAllCareerInternQuery({
    page,
  ...
  const columns: Column<UserProfile>[] = [
    {
      ...
      onColumnClick: (item) => router.push('/auth/career/intern/' + item._id),
    },
    {
      key: 'email',
      header: 'Email',
