...
import { useGetAllCareerOthersQuery, UserProfile } from '@/api/career';
...
function CareerOthers() {
  ...
  const { data } = useGetAllCareerOthersQuery({
    page,
  ...
  const columns: Column<UserProfile>[] = [
    {
      ...
      onColumnClick: (item) => router.push('/auth/career/others/' + item._id),
    },
    {
      key: 'email',
      header: 'Email',
