...
import { CareerOtherInput, useCareerOtherMutation } from '@/api/career';
...
const CAOtherForm = () => {
  ...
  const [careerOther, { isLoading }] = useCareerOtherMutation();
  ...
  const handleSubmit = async (values: CareerOtherInput) => {
    const res = await careerOther(values);
          ...
          <div className="rounded-lg bg-[#F4FAFC] p-6">
            ...
            <div className="mb-4 grid grid-cols-1 gap-4 md:grid-cols-4">
              <Input
                ...
                registration={register(`professional_qualification.field`)}
                error={
              ...
              <Input
                ...
                error={
                  formState.errors?.professional_qualification?.institution_name
                }
              />
              <Select
                required
                ...
                error={
                  formState.errors?.professional_qualification?.passed_year
                }
              />
              <Input
                required
