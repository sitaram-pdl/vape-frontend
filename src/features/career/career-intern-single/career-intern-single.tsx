...
import { GetCareerInternType } from '@/api/career';
...
interface CareerArticleProps {
  articledata: GetCareerInternType | undefined;
}

const CareerInternSingle: React.FC<CareerArticleProps> = ({ articledata }) => {
          ...
          <div className="mb-3 flex flex-col gap-4 rounded-md bg-white p-3">
            ...
            <div className="flex flex-col gap-3 bg-gray-100 p-3">
              <div className="flex justify-between rounded-md ">
                ...
                <Typography variant="small">
                  {articledata?.professional_qualification.instituition_name}
                </Typography>
              </div>
              <div className="flex justify-between rounded-md ">
...
export default CareerInternSingle;
